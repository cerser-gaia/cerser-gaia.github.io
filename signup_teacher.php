...
<body data-spy="scroll" data-target=".mainmenu-area" data-offset="90">
    ...
    <script>
        function validateForm() {
            var name = document.forms["validForm"]["teachername"].value;
        ...
        <?php
            $teachernameErr = $schoolnameErr  = $emailErr = $passwordErr = $passwordconfirmErr = $err_message = "";
            $teachername = $schoolname = $email = $password = $passwordconfirm = "";
            $teachernameDB = $schoolnameDB = $emailDB = $passwordDB = $passwordconfirmDB = 0;
    ...
    <?php
        if(($teachernameDB==1) && ($schoolnameDB==1) && ($emailDB == 1) && ($passwordDB == 1) && ($passwordconfirmDB == 1)){
            $hostname = 'localhost';
            $username = "root";
            $password = "";
            ...
            // insert query
            $sql = "INSERT INTO `district_student` (`Sname`, `SID`, `TRcode`, `Semail`, `Spswrd`) VALUES ('$teachername', '$studid', '$roomcode', '$email', '$password');";
        ...
        // Example Output: 70Fmr9mOlGID7OhtTbyj
    ...
    <section class="section-padding">
                <div class="container">
                    <!-- input statements-->
                    <div align="center">
                        <h2 class="xs-font26">Teacher/Faculty Sign Up Form</h2><br>
                    </div>
            <form name="signupForm" onsubmit="return validateForm()" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">  
                        ...
                        Name: <input type="text" name="teachername" value="<?php echo $teachername;?>">
